...
fname = 'C:\Users\Administrator\Documents\REVORGDATA\data\chromatin\iduchromatin.tif';
...
Image1procolor = cat(3, dim,Image1proc,dim);
...
filename = ['chromatin-forfig1-idu-deconv-whole.tif'];
R3 = {filename};
charR = cell2mat(R3);
...
myFolder = 'C:\Users\Administrator\Documents\REVORGDATA\paper\extractionScripts';
filename = ['chromatin-fig1b-idu-deconv-color.png'];
R3 = {filename};
charR = cell2mat(R3);
fullFileName = fullfile(myFolder, charR);
...
myFolder = 'C:\Users\Administrator\Documents\REVORGDATA\paper\extractionScripts';
filename = ['chromatin-fig1b-idu-deconv-color.tiff'];
R3 = {filename};
charR = cell2mat(R3);
fullFileName = fullfile(myFolder, charR);
imwrite(uint16(Image1procolor), fullFileName);
