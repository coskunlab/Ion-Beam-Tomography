...
Image1procolor = cat(3, dim,Image1procf,Image1procf);
...
filename = ['nanotag-forfig1-fluo-deconv-whole.tif'];
R3 = {filename};
charR = cell2mat(R3);
...
myFolder = 'C:\Users\Administrator\Documents\REVORGDATA\paper\extractionScripts';
filename = ['nanotag-fig1b-fluo-deconv-gray.tif'];
R3 = {filename};
charR = cell2mat(R3);
fullFileName = fullfile(myFolder, charR);
...
myFolder = 'C:\Users\Administrator\Documents\REVORGDATA\paper\extractionScripts';
filename = ['nanotag-fig1b-fluo-deconv-color.png'];
R3 = {filename};
charR = cell2mat(R3);
fullFileName = fullfile(myFolder, charR);
...
myFolder = 'C:\Users\Administrator\Documents\REVORGDATA\paper\extractionScripts';
filename = ['nanotag-fig1b-fluo-deconv-color.tiff'];
R3 = {filename};
charR = cell2mat(R3);
fullFileName = fullfile(myFolder, charR);
imwrite(uint16(Image1procolor), fullFileName);
